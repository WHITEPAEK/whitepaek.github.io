...
<Img caption="[그림 1] application.properties 설정">
...
<Img caption="[그림 2] localhost:8080 접속">
...
<Img caption="[그림 3] id_token을 Decoded">
...
<Img caption="[그림 4] id_token을 공개키 서명 확인">
...
<Img caption="[그림 5] Apple ID 로그인 화면으로 이동">
