...
<Img caption="[그림 1] 인 앱 결제 프로세스(In-App Purchase Process)">
...
<Img caption="[그림 2] application.properties 설정">
...
## 2. App Store에게 receipt-data 검증 요청 (/verfityReceipt)
...
<Img caption="[그림 3] 인 앱 결제 프로세스 이슈(In-App Purchase Process Issue)">
