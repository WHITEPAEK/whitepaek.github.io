...
const activities: Activity[] = [
  {
    ...
    description: `JetBrains 주최 행사에 패널로 초청되어, "온/오프라인 인플루언서와 함께하는 IntelliJ IDEA와 생산성에 대한 이야기" 세션에서 발표한 경험이 있습니다.`,
    url: `https://blog.jetbrains.com/ko/blog/2020/11/30/jetbrains-productivity-day-2020/`,
  },
  {
    period: "2020. 06. 30.",
    title: '"IntelliJ IDEA 프로젝트에 활용하기" 도서 출판',
    description: `Java, Spring F/W 개발 환경에서 IntelliJ IDEA 학습을 다룬 도서를 국내 최초로 집필 및 출간한 경험이 있습니다.`,
